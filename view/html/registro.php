            ...
            <section id="contenedor_registro">
                ...
                <div id="form_registro">
                   ...
                   <form id="formulario" method="post" action="../../controllers/CRestControladorRegistroUser.php" >
                       ...
                       <input type="text" name="apodo" id="input_apodo" placeholder="Apodo" required >
                       ...
                       <input type="email" name="correo" id="input_correo" placeholder="Correo electrónico" required>
